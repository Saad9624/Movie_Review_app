    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Snackbar.make(view, "Add Action Movies", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                Snackbar.make(view, "Add Comedy Movies", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                Snackbar.make(view, "Add Adventure Movies", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                        */

               Intent intent = new Intent(AdminActivity.this, AdminaddActionActivity.class);
